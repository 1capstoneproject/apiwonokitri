...
@section('main')
            ...
            <div class="card-body p-4">
                <div class="d-flex justify-content-between align-items-center mb-4">
                    ...
                    <button 
                        ...
                        data-bs-target="#modalUsersCreate"
                    >
                        <i class="ti ti-plus"></i>
                        <span>Buat Users</span>
                    </button>

                    <div class="modal fade" id="modalUsersCreate" tabindex="-1" role="dialog" aria-labelledby="modalUsersCreateTitle" aria-hidden="true">
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    ...
                                    <div class="mb-3">
                                            ...
                                            <select name="roles_id" class="form-select" id="roles_id" aria-describedby="roles_id" required>
                        ...
                        <tbody>
                            @foreach ($users as $user)
                                <tr>
                                    ...
                                    <td>
                                        <div class="dropdown">
                                            <button @if($user->roles->id == 3) disabled @endif class="btn btn-primary dropdown-toggle" type="button" id="action-menu-{{ $user->id }}-button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                                Action
                                            </button>
    ...
    @foreach ($users as $user)
        <div class="modal fade" id="modalUsersEdit{{$user->id}}" tabindex="-1" role="dialog" aria-labelledby="modalUsersEdit{{$user->id}}Title" aria-hidden="true">
            <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
                <div class="modal-content">
                    <form enctype="multipart/form-data" method="POST" action="{{ route('users.edit', ['id' => $user->id]) }}">
                    @csrf
                    @method("PUT")
                    <div class="modal-header">
                    ...
                    <div class="modal-body">
                        <div class="row mb-3">
                            <div class="mb-3 col-sm-12 col-md-6">
                                <label for="name" class="form-label">Name</label>
                                <input type="text" value="{{ $user->name }}" name="name" class="form-control" id="name" aria-describedby="name">
                            </div>
                            <div class="mb-3 col-sm-12 col-md-6">
                                <label for="email" class="form-label">Email</label>
                                <input type="email" value="{{ $user->email }}" name="email" class="form-control" id="email" aria-describedby="email">
                            </div>
                        </div>
                        <div class="row mb-3">
                            <div class="mb-3 col-sm-12 col-md-6">
                                <label for="description" class="form-label">Description</label>
                                <input type="text" value="{{ $user->description }}" name="description" class="form-control" id="description" aria-describedby="description">
                            </div>
                            <div class="mb-3 col-sm-12 col-md-6">
                                <label for="address" class="form-label">Address</label>
                                <input type="text" value="{{ $user->address }}" name="address" class="form-control" id="address" aria-describedby="address">
                            </div>
                        </div>
                        <div class="mb-3">
                            <label for="password" class="form-label">Password</label>
