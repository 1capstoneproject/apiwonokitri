...
@section('main')
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="file" name="files" class="form-control" id="files" aria-describedby="files">
                                    </div>
                                </div>
                        ...
                        <tbody>
                            ...
                            @foreach($banners as $banner)
                                <tr>
                                    <td>{{ $bannerCount }}</td>
                                    <td>
                                        <img src="{{ asset($banner->path) }}" width="320" class="rounded" alt="{{ $banner->name }}">
                                    </td>
                                    <td>{{ $banner->name }}</td>
                                    <td>
                                        <div class="dropdown">
                                            <button class="btn btn-primary dropdown-toggle" type="button" id="action-menu-{{ $banner->id }}-button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                                Aksi
                                            </button>
                                            <div class="dropdown-menu" aria-labelledby="action-menu-{{ $banner->id }}-button">
                                                <button
                                                    class="dropdown-item"
                                                    data-bs-toggle="modal"
    ...
    @foreach($banners as $banner)
    <div class="modal fade" id="modalBannerEdit{{ $banner->id }}" tabindex="-1" role="dialog" aria-labelledby="modalBannerEdit{{ $banner->id }}Title" aria-hidden="true">
        <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="mb-3">
                        <label for="name" class="form-label">Banner Name</label>
                        <input type="text" name="name" value="{{ $banner->name }}" class="form-control" id="name" aria-describedby="name">
                    </div>
                    <div class="mb-3">
                        <label for="email" class="form-label">Banner Image</label>
                        <input type="file" name="files" class="form-control" id="files" aria-describedby="files">
