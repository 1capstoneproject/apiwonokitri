...
<body>
    ...
    <div class="page-wrapper" id="main-wrapper" data-layout="vertical" data-navbarbg="skin6" data-sidebartype="full"
        ...
        <aside class="left-sidebar">
            ...
            <div>
                <div class="brand-logo d-flex align-items-center justify-content-between">
                    <a href="" class="text-nowrap logo-img" style="padding-top: 1.5rem">
        ...
        <div class="body-wrapper">
                        ...
                        <ul class="navbar-nav flex-row ms-auto align-items-center justify-content-end">
                            <li class="nav-item dropdown">
                                <a class="nav-link nav-icon-hover" href="javascript:void(0)" id="drop2"
                                    ...
                                    <img src="{{ asset(auth()->user()->profile ?? 'images/profile/no-images.png') }}"
            ...
            <div class="modal fade" id="modalProfileEdit{{ auth()->user()->id }}" tabindex="-1" role="dialog"
                aria-labelledby="modalProfileEdit{{ auth()->user()->id }}Title" aria-hidden="true">
                <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
                    <div class="modal-content">
                        <form enctype="multipart/form-data" method="POST"
                            action="{{ route('users.edit', ['id' => auth()->user()->id]) }}">
                            @csrf
                            @method('PUT')
                            <div class="modal-header">
                                <h5 class="modal-title" id="modalProfileEdit{{ auth()->user()->id }}Title">My Profile
                                </h5>
                            ...
                            <div class="modal-body">
                                ...
                                <div class="row mb-3">
                                    <div class="mb-3 col-sm-12 col-md-6">
                                        ...
                                        <input type="text" value="{{ auth()->user()->description }}"
